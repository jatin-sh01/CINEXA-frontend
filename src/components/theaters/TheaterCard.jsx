    ...
    >
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1">
          <h3 className="text-gray-900 font-bold text-lg leading-tight">{theater.name}</h3>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-medium text-gray-900 truncate">{theater.city || "—"}</p>
          </div>
        </div>
        ...
        {theater.pincode && (
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-medium text-gray-900">{theater.pincode}</p>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-medium text-gray-900">{theater.totalScreens || 1}</p>
          </div>
        </div>
      </div>
