...
export default function PaymentPage() {
  ...
  if (!payment)
    return <p className="text-gray-500 text-center py-12">Payment not found</p>;
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10 space-y-6">
      ...
      <div className="bg-gray-900 rounded-xl p-6 space-y-3 text-sm text-gray-300">
        ...
        <p>
          <strong>Method:</strong> {payment.paymentMethod?.replace(/_/g, " ")}
        </p>
        <p>
          <strong>Status:</strong>{" "}
          <span
            className={`inline-block px-2 py-0.5 rounded-full text-xs ${statusColor[payment.paymentStatus] || ""}`}
          >
