...
import { FiFilm, FiMapPin, FiClock, FiUsers, FiDollarSign, FiArrowRight } from "react-icons/fi";
    ...
    <div className="min-h-screen bg-white px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-1">My Bookings</h1>
            <p className="text-gray-600 text-sm">Manage and track your cinema bookings</p>
          </div>
          <Link to="/profile" className="text-gray-600 hover:text-gray-900 text-sm font-medium border border-gray-300 rounded-lg px-4 py-2 transition-all hover:shadow-md">
            My Profile
          </Link>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-12 text-center">
          ...
          <Link to="/movies" className="inline-block bg-gray-900 text-white px-6 py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors">
            Browse Movies
          </Link>
        </div>
      ) : (
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <FiFilm className="text-gray-400 shrink-0" size={20} />
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 font-medium">{b.timing}</p>
                        </div>
                      </div>
